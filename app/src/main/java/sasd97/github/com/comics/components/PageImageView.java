...
public class PageImageView extends AppCompatImageView {
    ...
    public void setViewMode(PageImageConstants.PageViewMode viewMode) {
        mViewMode = viewMode;
        mSkipScaling = false;
        requestLayout();
        invalidate();
    ...
    private void init() {
        ...
        mViewMode = PageImageConstants.PageViewMode.ASPECT_FIT;
    }
    ...
    private void scale() {
        ...
        if (mViewMode == PageImageConstants.PageViewMode.ASPECT_FILL) {
            float scale;
            float dx = 0;
        ...
        else if (mViewMode == PageImageConstants.PageViewMode.ASPECT_FIT) {
        ...
        else if (mViewMode == PageImageConstants.PageViewMode.FIT_WIDTH) {
